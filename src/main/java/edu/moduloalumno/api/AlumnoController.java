...
public class AlumnoController {
	...
	@RequestMapping(value = "/buscarcod/{codigo}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<Alumno> getAlumnoBycodigo(@PathVariable("codigo") String codigo) {
		logger.info("> getAlumnoById [Alumno]");

		Alumno alu = null;
		try {
			alu = service.getAlumnoBycodigo(codigo);
